...
import logging
import filecmp
from falcontradis.ExperimentCollection import ExperimentCollection
from falcontradis.ExperimentMetaData import ExperimentMetaData

class ErrorReadingFile (Exception): pass
class InvalidFileFormat (Exception): pass

data_dir = os.path.join('falcontradis','tests', 'data','experimentcollection')
...
class TestExperimentCollection(unittest.TestCase):
	...
	def test_vary_mic(self):
		...
		expected_output = """project.drug_0.sequence=falcontradis/tests/data/experimentcollection/reference
project.drug_0.userplot=falcontradis/tests/data/experimentcollection/control falcontradis/tests/data/experimentcollection/condition_0.25_0_rep1 falcontradis/tests/data/experimentcollection/condition_0.25_0_rep2 falcontradis/tests/data/experimentcollection/condition_0.5_0_rep1 falcontradis/tests/data/experimentcollection/condition_0.5_0_rep2 falcontradis/tests/data/experimentcollection/condition_1_0_rep1 falcontradis/tests/data/experimentcollection/condition_1_0_rep2 falcontradis/tests/data/experimentcollection/condition_2_0_rep1 falcontradis/tests/data/experimentcollection/condition_2_0_rep2
"""
