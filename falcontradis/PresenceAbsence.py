...
from falcontradis.GeneReport import GeneReport
from falcontradis.HeatMap import HeatMap
from falcontradis.GeneToFiles import GeneToFiles
from falcontradis.ReorderGenes import ReorderGenes
